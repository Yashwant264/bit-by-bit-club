      ...
      <div className="relative z-10 w-full overflow-hidden unified-homepage-context">
        ...
        <section className="relative z-10 px-6 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            {/* SAFE WRAPPER: Targets only the actual card components directly generated by BentoGrid without breaking light/dark tokens */}
            <div className="[&_.glass-card-surface]:!bg-[var(--bg-surface)] [&_.glass-strong]:!bg-[var(--bg-surface)] [&_div[class*='glass']]:!bg-[var(--bg-surface)] [&_div[class*='glass']]:!border-[var(--border-subtle)] [&_div[class*='glass']]:!text-[var(--text-primary)] [&_div]:!opacity-100">
              <BentoGrid />
            </div>
          </div>
        </section>
