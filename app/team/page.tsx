...
const DEPARTMENTS: Department[] = [
  {
    ...
    icon: <Code2 size={15} />,
    members: [
      { id: 101, name: 'Vedant Mishra', role: 'Technical Lead', tier: 'Lead', year: 'Second Year · CSE', photo: '/team/vedant-mishra.jpg', accentIndex: 0, socials: { github: '#', linkedin: '#' } },
      { id: 102, name: 'Dipanshu Joshi', role: 'Technical Co-Lead', tier: 'Co-Lead', year: 'Second Year · CSE', photo: '/team/dipanshu-joshi.jpg', accentIndex: 1, socials: { github: '#', twitter: '#' } },
  ...
  },
  {
    ...
    members: [
      { id: 201, name: 'Akshit Bakshi', role: 'Design Lead', tier: 'Lead', year: 'Second Year · CSE', photo: '/team/akshit-bakshi.jpg', accentIndex: 1, socials: { instagram: '#', linkedin: '#' } },
      { id: 202, name: 'Gayatri Palodkar', role: 'Design Co-Lead', tier: 'Co-Lead', year: 'First Year · CSE', photo: '/team/gayatri-palodkar.jpg', accentIndex: 2, socials: { instagram: '#' } },
